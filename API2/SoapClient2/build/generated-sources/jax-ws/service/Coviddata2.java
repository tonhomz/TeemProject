...
public class Coviddata2 {
    ...
    public String toString() {
        return "Coviddata2{" + "newCase=" + newCase + ", newCaseExcludeabroad=" + newCaseExcludeabroad + ", newDeath=" + newDeath + ", province=" + province + ", totalCase=" + totalCase + ", totalCaseExcludeabroad=" + totalCaseExcludeabroad + ", totalDeath=" + totalDeath + ", updateDate=" + updateDate + ", weeknum=" + weeknum + ", yy=" + yy + '}';
    }
